...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Departments d1 = new Departments(new int(), "Computers");

            Departments d2 = new Departments(new int(), "Electronics");

            Departments d3 = new Departments(new int(), "Fashion");

            Departments d4 = new Departments(new int(), "Books");
